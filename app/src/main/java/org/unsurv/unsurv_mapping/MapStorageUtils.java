...
public class MapStorageUtils {
  ...
  public final static int FIXED_CAMERA = 0;
  public final static int DOME_CAMERA = 1;
  public final static int PANNING_CAMERA = 2;

  // strings in order of types for easy access
  public final static List<String> typeList = new ArrayList<>(Arrays.asList("fixed", "dome", "panning"));

  // osm "surveillance" tag
  public final static int AREA_UNKNOWN = 0;
  public final static int AREA_OUTDOOR = 1;
  public final static int AREA_PUBLIC = 2;
  public final static int AREA_INDOOR = 3;
  public final static int AREA_TRAFFIC = 4;

  public final static List<String> areaList = new ArrayList<>(Arrays.asList(
          "unknown",
          "outdoor",
          "public",
          "indoor",
  ...
  // osm mount types
  public final static int MOUNT_UNKNOWN = 0;
  public final static int MOUNT_POLE = 1;
  public final static int MOUNT_WALL = 2;
  public final static int MOUNT_CEILING = 3;
  public final static int MOUNT_STREET_LAMP = 4;

  public final static List<String> mountList = new ArrayList<>(Arrays.asList(
          "unknown",
          "pole",
          "wall",
          "ceiling",
...
public final static int COMPLETE_SIGN_PRESENT = 1;
  ...
  public final static String CAMERA_CAPTURES_PATH = Environment.getExternalStoragePublicDirectory(
          Environment.DIRECTORY_PICTURES).getAbsolutePath() + "/unsurv/cameras/captures/";

  public final static String TRAINING_CAPTURES_PATH = Environment.getExternalStoragePublicDirectory(
  ...
  public static int chooseMarker(int cameraType, int cameraArea) {

    // TODO lookup table instead of ugly nested switches

    switch (cameraType) {

      case MapStorageUtils.FIXED_CAMERA:
      ...
      case MapStorageUtils.DOME_CAMERA:
      ...
      case MapStorageUtils.PANNING_CAMERA:
